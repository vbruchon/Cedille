...
// Envoyer les données de contact à votre script
function mon_script_data() {
	$contact = new WP_Query(array('post_type' => 'contact'));
    ...
    wp_localize_script( 'contact_element-script', 'contact_data', $contact_data );
	endwhile;
}
add_action( 'wp_enqueue_scripts', 'mon_script_data' );
